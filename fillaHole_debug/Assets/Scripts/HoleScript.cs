...
public class HoleScript : MonoBehaviour
{
    ...
    private bool isOpenCoroutineRunning = false;
    ...
    {
        // Am I a filled hole
        if (filled && !isOpenCoroutineRunning)
        {
    ...
    private IEnumerator Open()
    {
        ...
        if (!filled)
        {
            Debug.Log("Missed!"); // Log a message to the console
